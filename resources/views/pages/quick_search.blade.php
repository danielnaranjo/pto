<div class="m-list-search__results">
    ...
    @forelse ($packages as $package)
    	<a href="/package/{{ $package->package_id }}" class="m-list-search__result-item">
    		<span class="m-list-search__result-item-icon"><i class="fa fa-building-o  m--font-warning"></i></span>
    		<span class="m-list-search__result-item-text"> {{ $package->title }}</span>
    	</a>
    @empty
    ...
    <a href="/ver/{{ strtolower($service->type ) }}" class="m-list-search__result-item">
        <span class="m-list-search__result-item-icon"><i class="fa fa-address-card-o m--font-warning"></i></span>
        <span class="m-list-search__result-item-text">{{ $service->type }}</span>
    </a>
    @empty
    <a href="#" class="m-list-search__result-item">
        <span class="m-list-search__result-item-icon"><i class="fa fa-times  m--font-danger"></i></span>
    ...
    <a href="/u/{{ $user->slug }}" class="m-list-search__result-item">
        <span class="m-list-search__result-item-icon"><i class="fa fa-address-card-o m--font-warning"></i></span>
    ...
    @forelse ($travellers as $travel)
    	<a href="/travel/{{ $travel->travel_id }}" class="m-list-search__result-item">
    		<span class="m-list-search__result-item-icon"><i class="fa fa-building-o  m--font-warning"></i></span>
    		<span class="m-list-search__result-item-text"> {{ $travel->title }}</span>
    	</a>
    @empty
    <a href="#" class="m-list-search__result-item">
        <span class="m-list-search__result-item-icon"><i class="fa fa-times m--font-danger"></i></span>
    ...
    <p style="padding:30px 0 0 0 !important"><!--  class="pull-right"  -->
        <a href="https://www.algolia.com/?utm_source=paqueto.com" target="_new">
