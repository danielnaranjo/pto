					...
					<div class="m-stack m-stack--hor m-stack--desktop">
						<div class="m-stack__item m-stack__item--fluid">
							<div class="m-login__wrapper">
								...
								<div class="m-login__signin">
									<div class="m-login__head">
										<h3 class="m-login__title">
											Accede a tuconsorcio
										</h3>
									</div>
									<!-- <form class="m-login__form m-form" action=""> -->
                                    {!! Form::open(['url' => 'login', 'class' => 'm-login__form m-form ']) !!}
										<div class="form-group m-form__group">
											<input class="form-control m-input" type="text" placeholder="Usuario" name="usuario" autocomplete="off">
										</div>
										<div class="form-group m-form__group">
								...
								<div class="m-login__forget-password" style="display:none;">
									<div class="m-login__head">
										<h3 class="m-login__title">
											Forgotten Password ?
										</h3>
						...
						<div class="m-stack__item m-stack__item--center">
							<div class="m-login__account">
								...
								&nbsp;&nbsp;
								<a href="javascript:;" id="" class="m-link m-link--focus m-login__account-link"><!--m_login_signup -->
									Contáctanos
								</a>
							</div>
						</div>
				...
				<div class="m-grid__item m-grid__item--fluid m-grid m-grid--center m-grid--hor m-grid__item--order-tablet-and-mobile-1	m-login__content colorprincipal">
					<div class="m-grid__item m-grid__item--middle">
						<h3 class="m-login__welcome">
							Administra tu consorcio de forma fácil y sencilla.
						</h3>
						<p class="m-login__msg">
							La mejor manera de comunicación entre administradores y propietarios.
						</p>
					</div>
				</div>
			</div>
